...
var App = function App() {
  ...
  var _useState9 = useState(function () {
    ...
    cloudCfg = _useState0[0],
    setCloudCfg = _useState0[1];
  var _useState1 = useState(false),
    _useState10 = _slicedToArray(_useState1, 2),
    cloudOn = _useState10[0],
    setCloudOn = _useState10[1];
  var _useState11 = useState(0),
    _useState12 = _slicedToArray(_useState11, 2),
    cloudVersion = _useState12[0],
    setCloudVersion = _useState12[1]; // 用于强制重新加载
  ...
  useEffect(function () {
    ...
    _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      var cloud, localRecords, cloudById, localOnly, localNewer, keepLocalIds, merged, count;
            ...
            if (cloud !== null) {
              ...
              (localRecords || []).forEach(function (local) {
                ...
                if (!remote) {
                  ...
                  var remoteTs = new Date(remote.updated_at || remote.updatedAt || remote.created_at || 0).getTime();
              ...
              if (localOnly.length > 0 || localNewer.length > 0) {
                // 合并: 本地未同步的优先保留,其他用云端
                keepLocalIds = new Set([].concat(localOnly, localNewer).map(function (r) {
                  return r.id;
                }));
                merged = [].concat(localOnly, localNewer, _toConsumableArray((cloud || []).filter(function (c) {
                  return !keepLocalIds.has(c.id);
                })));
                setRecords(merged);
                count = localOnly.length + localNewer.length;
                console.warn("[fix7 \u6570\u636E\u4FDD\u62A4] \u68C0\u6D4B\u5230 ".concat(count, " \u6761\u672C\u5730\u672A\u540C\u6B65\u8BB0\u5F55 \u2014 \u672C\u5730\u72EC\u6709: ").concat(localOnly.length, ",\u672C\u5730\u66F4\u65B0: ").concat(localNewer.length, "\u3002\u5DF2\u6062\u590D\u5E76\u5C06\u81EA\u52A8\u91CD\u65B0\u4E0A\u4F20\u3002"));
                // toast 在 useToast 还没初始化时不能用,延后
                setTimeout(function () {
                  try {
                    toast && toast("\u26A0 \u6062\u590D ".concat(count, " \u6761\u672C\u5730\u672A\u540C\u6B65\u8BB0\u5F55,\u6B63\u5728\u91CD\u65B0\u4E0A\u4F20..."));
                  } catch (e) {}
                }, 200);
  ...
  var uploadRecordsWithRetry = /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(recordsToUpload) {
      var maxRetries,
        meaningful,
        attempt,
        cleaned,
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            maxRetries = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : 5;
          ...
          case 2:
            ...
            cleaned = meaningful.map(sanitizeRecordForCloud);
            _context4.n = 3;
          ...
          case 4:
            ...
            missingField = match[1]; // 🆕 fix8: 剥离任意 schema 缓存里找不到的列(不再限定白名单)
            ...
            console.warn("[fix8 schema-retry] workspace_records \u7F3A\u5C11\u5217 \"".concat(missingField, "\",\u5DF2\u81EA\u52A8\u5265\u79BB\u91CD\u8BD5 (\u7B2C ").concat(attempt + 1, "/").concat(maxRetries, " \u6B21)\u3002\u5EFA\u8BAE\u4E3B\u7BA1\u5728 Supabase \u8865\u5EFA\u8BE5\u5217\u3002"));
            attempt++;
            return _context4.a(3, 2);
          case 5:
            throw error;
          case 6:
    ...
    return function uploadRecordsWithRetry(_x) {
  ...
  var _useState17 = useState(null),
    ...
    cloudSyncError = _useState18[0],
    setCloudSyncError = _useState18[1];
  useEffect(function () {
    if (!cloudOn || !user) return;
    var t = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      var current, _t3;
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.p = _context5.n) {
          case 0:
            current = recordsRef.current;
            if (!(current.length === 0)) {
              _context5.n = 1;
              break;
            }
          ...
          case 1:
            _context5.p = 1;
            _context5.n = 2;
            return uploadRecordsWithRetry(current);
          case 2:
          ...
          case 3:
            _context5.p = 3;
            _t3 = _context5.v;
            console.error('云端写入失败', _t3);
            setCloudSyncError(_t3.message);
          case 4:
            return _context5.a(2);
        }
      }, _callee5, null, [[1, 3]]);
  ...
  useEffect(function () {
    window.__requestSupervisorAssistance = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
      var _ref14,
        entityType,
        entityId,
        entityTitle,
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.p = _context6.n) {
          case 0:
            _ref14 = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : {}, entityType = _ref14.entityType, entityId = _ref14.entityId, entityTitle = _ref14.entityTitle, level = _ref14.level;
            if (user) {
              _context6.n = 1;
              break;
            }
  ...
  var _useState23 = useState(function () {
    ...
    refundProcessors = _useState24[0],
    setRefundProcessors = _useState24[1];
  useEffect(function () {
    if (!cloudOn || !CLOUD.client) return;
    _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
      var _data$value2, _yield$CLOUD$client$f4, data, ids, _t5;
  ...
  useEffect(function () {
    ...
    window.__setRefundProcessors = /*#__PURE__*/function () {
      var _ref16 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(newIds, currentUserName) {
        var userNames, _yield$CLOUD$client$f5, error, _t6;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            ...
            case 2:
              _yield$CLOUD$client$f5 = _context8.v;
            ...
            case 4:
              _context8.p = 4;
              _t6 = _context8.v;
              alert('保存退款处理人配置失败: ' + (_t6.message || _t6));
              return _context8.a(2, false);
          }
        }, _callee8, null, [[1, 4]]);
      }));
  ...
  var _useState25 = useState([]),
    ...
    cdmMessages = _useState26[0],
    setCdmMessages = _useState26[1];
  var _useState27 = useState(false),
    _useState28 = _slicedToArray(_useState27, 2),
    cdmLoading = _useState28[0],
    setCdmLoading = _useState28[1];
  var cdmLoadingRef = useRef(false);
  // 🆕 v22-CV/CW: 店铺-负责人映射 + 超时阈值配置 (三方共享)
  var _useState29 = useState([]),
    _useState30 = _slicedToArray(_useState29, 2),
    shopOwners = _useState30[0],
    setShopOwners = _useState30[1];
  var _useState31 = useState({}),
    _useState32 = _slicedToArray(_useState31, 2),
    cdmTimeoutConfig = _useState32[0],
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.p = _context9.n) {
          ...
          case 2:
            ...
            CDM_LIST_COLS = 'id,from_system,from_user_id,from_user_name,to_system,to_user_id,to_user_name,category,priority,title,body,related_ref,related_type,related_shop,assigned_to_id,assigned_to_name,assigned_by_id,assigned_by_name,assigned_at_ms,watchers,status,read_by,created_at_ms,updated_at';
            _context9.n = 4;
  ...
  var loadShopOwners = /*#__PURE__*/function () {
    var _ref18 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
      var client, _yield$client$from$se2, data, error, _t8;
      return _regenerator().w(function (_context0) {
        while (1) switch (_context0.p = _context0.n) {
          ...
          case 2:
            _yield$client$from$se2 = _context0.v;
          ...
          case 4:
            _context0.p = 4;
            _t8 = _context0.v;
            console.warn('[CDM] 加载 shop_owners 失败', _t8);
          case 5:
            return _context0.a(2);
        }
      }, _callee0, null, [[1, 4]]);
  ...
  var loadCdmTimeoutConfig = /*#__PURE__*/function () {
    var _ref19 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
      var client, _yield$client$from$se3, data, error, _t9;
      return _regenerator().w(function (_context1) {
        while (1) switch (_context1.p = _context1.n) {
          ...
          case 2:
            _yield$client$from$se3 = _context1.v;
          ...
          case 4:
            _context1.p = 4;
            _t9 = _context1.v;
            console.warn('[CDM] 加载 cdm_timeout_config 失败', _t9);
          case 5:
            return _context1.a(2);
        }
      }, _callee1, null, [[1, 4]]);
  ...
  useEffect(function () {
    ...
    try {
      channel = client.channel(channelName).on('postgres_changes', {
        ...
        var _payload$new2, _payload$new3;
        loadCdmMessages();
        // 是新消息且发给客服部 → 桌面通知
        if ((payload === null || payload === void 0 ? void 0 : payload.eventType) === 'INSERT' && (payload === null || payload === void 0 || (_payload$new2 = payload["new"]) === null || _payload$new2 === void 0 ? void 0 : _payload$new2.to_system) === 'cs' && (payload === null || payload === void 0 || (_payload$new3 = payload["new"]) === null || _payload$new3 === void 0 ? void 0 : _payload$new3.from_user_id) !== user.id) {
  ...
  var _useState33 = useState({
    ...
    layoutPrefs = _useState34[0],
    setLayoutPrefs = _useState34[1];
  // 登录或切换账号时重新加载该用户的布局
  useEffect(function () {
    if (!user) return;
  ...
  var _useState35 = useState(false),
    ...
    customizeOpen = _useState36[0],
    setCustomizeOpen = _useState36[1];
  ...
  var _useState37 = useState(function () {
    ...
    notifPerm = _useState38[0],
    setNotifPerm = _useState38[1];
  ...
  var _useState39 = useState(false),
    ...
    searchOpen = _useState40[0],
    setSearchOpen = _useState40[1];
  useEffect(function () {
  ...
  return /*#__PURE__*/React.createElement(SitesContext.Provider, {
    ...
    onClick: /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
      ...
      return _regenerator().w(function (_context13) {
        while (1) switch (_context13.p = _context13.n) {
          ...
          case 1:
            setCloudSyncError(null);
            skipped = skipFieldsRef.current.size;
            if (skipped > 0) {
              toast("\u2713 \u5DF2\u4E0A\u4F20 ".concat(records.length, " \u6761\uFF08\u81EA\u52A8\u5265\u79BB\u4E86 ").concat(skipped, " \u4E2A\u4E91\u7AEF\u7F3A\u5931\u5B57\u6BB5\uFF09"));
            } else {
  ...
  }, "\uD83D\uDD04 \u5F3A\u5236\u4E0A\u4F20 (", records.length, " \u6761)")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-start',
    ...
    employees: employees,
    records: records,
    onJumpTo: function onJumpTo(tab, params) {
      setActiveTab(tab);
      if (params !== null && params !== void 0 && params.section) {
        // 让 AdminModule 接收 section 参数(需要后续支持)
        STORE.set('admin_section_hint', params.section);
      }
    }
  }), /*#__PURE__*/React.createElement(CSModule, {
    user: user,
    employees: employees,
    records: records,
...
// 📦 版本日志 - 用户用来确认加载的是哪个版本
var APP_VERSION = '2026.05.30-fix138';
