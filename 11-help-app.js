...
var App = function App() {
                ...
                return _regenerator().w(function (_context5) {
                  while (1) switch (_context5.p = _context5.n) {
                    ...
                    case 3:
                      ...
                      _context5.n = 4;
                      return CLOUD.uploadImage('attachments', file, 'cs-records/');
                    case 4:
                      res = _context5.v;
                      if (res && res.url) {
                        s.url = res.url;
  ...
  var uploadRecordsWithRetry = /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(recordsToUpload) {
      var maxRetries,
        meaningful,
        attempt,
        cleaned,
    ...
    return function uploadRecordsWithRetry(_x3) {
  ...
  useEffect(function () {
    window.__requestSupervisorAssistance = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9() {
      var _ref17,
        entityType,
        entityId,
        entityTitle,
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.p = _context9.n) {
          case 0:
            _ref17 = _args9.length > 0 && _args9[0] !== undefined ? _args9[0] : {}, entityType = _ref17.entityType, entityId = _ref17.entityId, entityTitle = _ref17.entityTitle, level = _ref17.level;
            if (user) {
              _context9.n = 1;
              break;
            }
          ...
          case 8:
            _yield$CLOUD$client$f3 = _context9.v;
  ...
  useEffect(function () {
    ...
    _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
      var _data$value2, _yield$CLOUD$client$f4, data, ids, _t1;
  ...
  useEffect(function () {
    ...
    window.__setRefundProcessors = /*#__PURE__*/function () {
      var _ref19 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(newIds, currentUserName) {
        var userNames, _yield$CLOUD$client$f5, error, _t10;
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 2:
              _yield$CLOUD$client$f5 = _context1.v;
            ...
            case 4:
              _context1.p = 4;
              _t10 = _context1.v;
              alert('保存退款处理人配置失败: ' + (_t10.message || _t10));
              return _context1.a(2, false);
          }
        }, _callee1, null, [[1, 4]]);
      }));
  ...
  var loadCdmMessages = /*#__PURE__*/function () {
    var _ref20 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
      var client, cutoffMs, _yield$client$from$se, data, error, fb, _t11;
  ...
  var cdmIncrementalFetch = /*#__PURE__*/function () {
    var _ref21 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
      var client, since, _yield$client$from$se2, data, error, _t12;
      return _regenerator().w(function (_context11) {
        while (1) switch (_context11.p = _context11.n) {
          ...
          case 1:
            ...
            return _context11.a(2, loadCdmMessages());
          case 2:
            _context11.p = 2;
            _context11.n = 3;
          ...
          case 3:
            _yield$client$from$se2 = _context11.v;
  ...
  var loadShopOwners = /*#__PURE__*/function () {
    var _ref22 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
      var client, _yield$client$from$se3, data, error, _t13;
      return _regenerator().w(function (_context12) {
        while (1) switch (_context12.p = _context12.n) {
          ...
          case 2:
            _yield$client$from$se3 = _context12.v;
          ...
          case 4:
            _context12.p = 4;
            _t13 = _context12.v;
            console.warn('[CDM] 加载 shop_owners 失败', _t13);
          case 5:
            return _context12.a(2);
        }
      }, _callee12, null, [[1, 4]]);
  ...
  var loadCdmTimeoutConfig = /*#__PURE__*/function () {
    var _ref23 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
      var client, _yield$client$from$se4, data, error, _t14;
      return _regenerator().w(function (_context13) {
        while (1) switch (_context13.p = _context13.n) {
          ...
          case 2:
            _yield$client$from$se4 = _context13.v;
          ...
          case 4:
            _context13.p = 4;
            _t14 = _context13.v;
            console.warn('[CDM] 加载 cdm_timeout_config 失败', _t14);
          case 5:
            return _context13.a(2);
        }
      }, _callee13, null, [[1, 4]]);
  ...
  var switchAccount = /*#__PURE__*/function () {
    var _ref25 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(targetEmployee) {
    ...
    return function switchAccount(_x6) {
  ...
  return /*#__PURE__*/React.createElement(SitesContext.Provider, {
      ...
      return _regenerator().w(function (_context17) {
        while (1) switch (_context17.p = _context17.n) {
          ...
          case 2:
            _context17.p = 2;
            _t16 = _context17.v;
            setCloudSyncError(_t16.message);
            alert('❌ 上传失败：' + _t16.message);
          case 3:
    ...
    onSave: function onSave(_ref28) {
      var newTopKeys = _ref28.topKeys,
        newSidebarOrder = _ref28.sidebarOrder;
      return setLayoutPrefs(function (p) {
        return _objectSpread(_objectSpread({}, p), {}, {
          topKeys: newTopKeys,
...
// 📦 版本日志 - 用户用来确认加载的是哪个版本
var APP_VERSION = '2026.06.05-fix160';
