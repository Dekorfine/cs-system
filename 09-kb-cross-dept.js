...
var KbModule = function KbModule(_ref) {
  ...
  var sameDirUrl = "kb.html?user=".concat(userParam, "&alias=").concat(userAlias, "#user=").concat(userParam);
...
// ════════════════════════════════════════════════════════════════════
var FreightCalcModule = function FreightCalcModule(_ref24) {
  ...
  var _useState77 = useState('loading'),
    ...
    setLoadStatus = _useState78[1]; // loading / loaded / timeout
...
// ════════════════════════════════════════════════════════════════════
var ExpressInvoiceModule = function ExpressInvoiceModule(_ref26) {
...
var WorkflowModule = function WorkflowModule(_ref27) {
  var goTab = _ref27.goTab;
  var _useState89 = useState(null),
    _useState90 = _slicedToArray(_useState89, 2),
    sel = _useState90[0],
    setSel = _useState90[1];
  if (sel) {
...
var InfCard = function InfCard(_ref29) {
  var b = _ref29.b,
    onOpen = _ref29.onOpen,
    onStatus = _ref29.onStatus,
    onDel = _ref29.onDel,
...
var InfForm = function InfForm(_ref30) {
  var initial = _ref30.initial,
    onCancel = _ref30.onCancel,
    onSave = _ref30.onSave,
    saving = _ref30.saving,
    toast = _ref30.toast;
  var _useState91 = useState(_objectSpread({}, initial)),
...
var InfluencerModule = function InfluencerModule(_ref32) {
  ...
  var _useState93 = useState([]),
    ...
    briefs = _useState94[0],
    setBriefs = _useState94[1];
  var _useState95 = useState(true),
    _useState96 = _slicedToArray(_useState95, 2),
    loading = _useState96[0],
    setLoading = _useState96[1];
  var _useState97 = useState('pipeline'),
    _useState98 = _slicedToArray(_useState97, 2),
    view = _useState98[0],
    setView = _useState98[1]; // 'pipeline' | 'list'
  var _useState99 = useState('all'),
    _useState100 = _slicedToArray(_useState99, 2),
    fStatus = _useState100[0],
    setFStatus = _useState100[1];
  var _useState101 = useState('all'),
    _useState102 = _slicedToArray(_useState101, 2),
    fPlatform = _useState102[0],
    setFPlatform = _useState102[1];
  var _useState103 = useState(''),
    _useState104 = _slicedToArray(_useState103, 2),
    search = _useState104[0],
    setSearch = _useState104[1];
  var _useState105 = useState(null),
    _useState106 = _slicedToArray(_useState105, 2),
    editing = _useState106[0],
    setEditing = _useState106[1];
  var _useState107 = useState(false),
    _useState108 = _slicedToArray(_useState107, 2),
    saving = _useState108[0],
    setSaving = _useState108[1];
  ...
  var load = /*#__PURE__*/function () {
    var _ref33 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
  ...
  var save = /*#__PURE__*/function () {
    var _ref34 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(b) {
  ...
  var changeStatus = /*#__PURE__*/function () {
    var _ref35 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(b, st) {
  ...
  var del = /*#__PURE__*/function () {
    var _ref36 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(b) {
...
var CrossDeptModule = function CrossDeptModule(_ref37) {
  var user = _ref37.user,
    employees = _ref37.employees,
    messages = _ref37.messages,
    loading = _ref37.loading,
    onReload = _ref37.onReload,
    toast = _ref37.toast,
    _ref37$shopOwners = _ref37.shopOwners,
    shopOwners = _ref37$shopOwners === void 0 ? [] : _ref37$shopOwners,
    _ref37$cdmTimeoutConf = _ref37.cdmTimeoutConfig,
    cdmTimeoutConfig = _ref37$cdmTimeoutConf === void 0 ? {} : _ref37$cdmTimeoutConf;
  var isAdmin = user.role === 'admin' || user.role === 'super_admin';
  // 🆕 v22-CV/CW: 4 个 tab — inbox / assigned-to-me / overdue / sent
  var _useState109 = useState('inbox'),
    _useState110 = _slicedToArray(_useState109, 2),
    tab = _useState110[0],
    setTab = _useState110[1];
  ...
  var _useState111 = useState({
    ...
    dateFilter = _useState112[0],
    setDateFilter = _useState112[1];
  var _useState113 = useState('all'),
    _useState114 = _slicedToArray(_useState113, 2),
    filterStatus = _useState114[0],
    setFilterStatus = _useState114[1];
  ...
  var _useState117 = useState('all'),
    ...
    filterPriority = _useState118[0],
    setFilterPriority = _useState118[1];
  var _useState119 = useState('all'),
    _useState120 = _slicedToArray(_useState119, 2),
    filterFrom = _useState120[0],
    setFilterFrom = _useState120[1];
  var _useState121 = useState(''),
    _useState122 = _slicedToArray(_useState121, 2),
    search = _useState122[0],
    setSearch = _useState122[1];
  var _useState123 = useState(1),
    _useState124 = _slicedToArray(_useState123, 2),
    page = _useState124[0],
    setPage = _useState124[1];
  // 🆕 v22-CV/CW: 分页支持 20/50/100
  var _useState125 = useState(50),
    _useState126 = _slicedToArray(_useState125, 2),
    pageSize = _useState126[0],
    setPageSize = _useState126[1];
  var _useState127 = useState(false),
    _useState128 = _slicedToArray(_useState127, 2),
    showNew = _useState128[0],
    setShowNew = _useState128[1];
  var _useState129 = useState(null),
    _useState130 = _slicedToArray(_useState129, 2),
    openMsgId = _useState130[0],
    setOpenMsgId = _useState130[1];
  // 🆕 v22-CW Round 3b: 主管管理面板
  var _useState131 = useState(false),
    _useState132 = _slicedToArray(_useState131, 2),
    showShopOwners = _useState132[0],
    setShowShopOwners = _useState132[1];
  var _useState133 = useState(false),
    _useState134 = _slicedToArray(_useState133, 2),
    showTimeoutSettings = _useState134[0],
    setShowTimeoutSettings = _useState134[1];
  ...
  var _useState135 = useState(null),
    ...
    openMsgExtra = _useState136[0],
    setOpenMsgExtra = _useState136[1];
  useEffect(function () {
...
var CdmPager = function CdmPager(_ref39) {
  var page = _ref39.page,
    total = _ref39.total,
    count = _ref39.count,
    pageSize = _ref39.pageSize,
    setPageSize = _ref39.setPageSize,
...
var CdmMessageCard = function CdmMessageCard(_ref40) {
  var msg = _ref40.msg,
    user = _ref40.user,
    tab = _ref40.tab,
    onOpen = _ref40.onOpen,
    cdmTimeoutConfig = _ref40.cdmTimeoutConfig;
  ...
  }, "\xB7 ", peerIcon, " ", peerName))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
...
// 新建消息 modal
var CdmNewMessageModal = function CdmNewMessageModal(_ref41) {
  var user = _ref41.user,
    ...
    toast = _ref41.toast;
  var _useState137 = useState('design'),
    _useState138 = _slicedToArray(_useState137, 2),
    toSystem = _useState138[0],
    setToSystem = _useState138[1];
  var _useState139 = useState(''),
    _useState140 = _slicedToArray(_useState139, 2),
    toUserId = _useState140[0],
    setToUserId = _useState140[1]; // 🆕 v22-CW
  var _useState141 = useState(''),
    _useState142 = _slicedToArray(_useState141, 2),
    toUserName = _useState142[0],
    setToUserName = _useState142[1];
  var _useState143 = useState(''),
    _useState144 = _slicedToArray(_useState143, 2),
    relatedShop = _useState144[0],
    setRelatedShop = _useState144[1]; // 🆕 v22-CW
  var _useState145 = useState(''),
    _useState146 = _slicedToArray(_useState145, 2),
    customShop = _useState146[0],
    setCustomShop = _useState146[1]; // 🆕 v22-CY: 选"其他"时手填
  var _useState147 = useState([]),
    _useState148 = _slicedToArray(_useState147, 2),
    watchers = _useState148[0],
    setWatchers = _useState148[1]; // 🆕 v22-CW
  var _useState149 = useState('general'),
    _useState150 = _slicedToArray(_useState149, 2),
    category = _useState150[0],
    setCategory = _useState150[1];
  var _useState151 = useState('normal'),
    _useState152 = _slicedToArray(_useState151, 2),
    priority = _useState152[0],
    setPriority = _useState152[1];
  var _useState153 = useState(''),
    _useState154 = _slicedToArray(_useState153, 2),
    title = _useState154[0],
    setTitle = _useState154[1];
  var _useState155 = useState(''),
    _useState156 = _slicedToArray(_useState155, 2),
    body = _useState156[0],
    setBody = _useState156[1];
  var _useState157 = useState('order'),
    _useState158 = _slicedToArray(_useState157, 2),
    relatedType = _useState158[0],
    setRelatedType = _useState158[1];
  var _useState159 = useState(''),
    _useState160 = _slicedToArray(_useState159, 2),
    relatedRef = _useState160[0],
    setRelatedRef = _useState160[1];
  ...
  var _useState163 = useState(false),
    ...
    sending = _useState164[0],
    setSending = _useState164[1];
  var fileInputRef = useRef(null);
  // 🆕 fix62 v5: 共享人员目录(发工单选具体人)
  var _useState165 = useState([]),
    _useState166 = _slicedToArray(_useState165, 2),
    orgDir = _useState166[0],
    setOrgDir = _useState166[1];
  useEffect(function () {
  ...
  var readFiles = /*#__PURE__*/function () {
    var _ref43 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(files) {
      var arr, _iterator2, _step2, _loop3, _t11;
      return _regenerator().w(function (_context17) {
        while (1) switch (_context17.p = _context17.n) {
          ...
          case 2:
            ...
            return _context17.d(_regeneratorValues(_loop3()), 3);
          case 3:
            if (!_context17.v) {
              _context17.n = 4;
              break;
            }
            return _context17.a(3, 4);
          case 4:
            _context17.n = 2;
            break;
          case 5:
  ...
  useEffect(function () {
    var onPaste = /*#__PURE__*/function () {
      var _ref44 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(e) {
  ...
  var send = /*#__PURE__*/function () {
    var _ref45 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee17() {
      var client, finalShop, userName, msg, _yield$client$from$in, error, _t12;
      return _regenerator().w(function (_context19) {
        while (1) switch (_context19.p = _context19.n) {
          ...
          case 4:
            _yield$client$from$in = _context19.v;
...
var CdmDetailModal = function CdmDetailModal(_ref46) {
  var _findCdm;
  var msg = _ref46.msg,
    user = _ref46.user,
    _ref46$employees = _ref46.employees,
    employees = _ref46$employees === void 0 ? [] : _ref46$employees,
    _ref46$shopOwners = _ref46.shopOwners,
    shopOwners = _ref46$shopOwners === void 0 ? [] : _ref46$shopOwners,
    _ref46$cdmTimeoutConf = _ref46.cdmTimeoutConfig,
    cdmTimeoutConfig = _ref46$cdmTimeoutConf === void 0 ? {} : _ref46$cdmTimeoutConf,
    onClose = _ref46.onClose,
    onChanged = _ref46.onChanged,
    toast = _ref46.toast;
  var _useState167 = useState(''),
    _useState168 = _slicedToArray(_useState167, 2),
    replyText = _useState168[0],
    setReplyText = _useState168[1];
  var _useState169 = useState([]),
    _useState170 = _slicedToArray(_useState169, 2),
    replyAttachments = _useState170[0],
    setReplyAttachments = _useState170[1];
  var _useState171 = useState(false),
    _useState172 = _slicedToArray(_useState171, 2),
    sending = _useState172[0],
    setSending = _useState172[1];
  var _useState173 = useState(null),
    _useState174 = _slicedToArray(_useState173, 2),
    imgPreview = _useState174[0],
    setImgPreview = _useState174[1];
  var _useState175 = useState(false),
    _useState176 = _slicedToArray(_useState175, 2),
    showAssign = _useState176[0],
    setShowAssign = _useState176[1]; // 🆕 v22-CW
  var fileInputRef = useRef(null);
  ...
  // 打开时标记已读
  useEffect(function () {
    _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee18() {
      var client, readBy, next, _t13;
  ...
  var readFiles = /*#__PURE__*/function () {
    var _ref48 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(files) {
      var arr, _iterator4, _step4, _loop4, _t14;
      return _regenerator().w(function (_context22) {
        while (1) switch (_context22.p = _context22.n) {
          ...
          case 2:
            ...
            return _context22.d(_regeneratorValues(_loop4()), 3);
          case 3:
            if (!_context22.v) {
              _context22.n = 4;
              break;
      ...
      }, _callee19, null, [[1, 6, 7, 8]]);
    }));
    return function readFiles(_x1) {
  ...
  useEffect(function () {
    var onPaste = /*#__PURE__*/function () {
      var _ref49 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee20(e) {
  ...
  var reply = /*#__PURE__*/function () {
    var _ref50 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee21() {
      var client, _yield$client$from$se, latest, fetchErr, userName, newThread, _yield$client$from$up, error, _t15;
      return _regenerator().w(function (_context24) {
        while (1) switch (_context24.p = _context24.n) {
          ...
          case 4:
            _yield$client$from$se = _context24.v;
          ...
          case 6:
            _yield$client$from$up = _context24.v;
  ...
  var setStatus = /*#__PURE__*/function () {
    var _ref51 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee22(newStatus) {
      var client, userName, updates, _yield$client$from$se2, latest, curThread, topAtts, threadAtts, seen, merged, attNames, _yield$client$from$up2, error, _t16, _t17;
      return _regenerator().w(function (_context25) {
        while (1) switch (_context25.p = _context25.n) {
          ...
          case 3:
            _yield$client$from$se2 = _context25.v;
          ...
          case 8:
            _yield$client$from$up2 = _context25.v;
          ...
          case 10:
            _context25.p = 10;
            _t17 = _context25.v;
            alert('更新失败: ' + (_t17.message || _t17));
          case 11:
            return _context25.a(2);
        }
      }, _callee22, null, [[7, 10], [2, 4]]);
    }));
    return function setStatus(_x11) {
  ...
  var assignTo = /*#__PURE__*/function () {
    var _ref52 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee23(userId, userName) {
      var client, myName, _yield$client$from$se3, latest, newThread, _t18;
      return _regenerator().w(function (_context26) {
        while (1) switch (_context26.p = _context26.n) {
          ...
          case 3:
            _yield$client$from$se3 = _context26.v;
          ...
          case 5:
            _context26.p = 5;
            _t18 = _context26.v;
            alert('分派失败: ' + (_t18.message || _t18));
          case 6:
            return _context26.a(2);
        }
      }, _callee23, null, [[1, 5]]);
    }));
    return function assignTo(_x12, _x13) {
  ...
  var toggleWatcher = /*#__PURE__*/function () {
    var _ref53 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee24(uid, uname) {
      var client, _yield$client$from$se4, latest, current, isWatching, next, _t19;
      return _regenerator().w(function (_context27) {
        while (1) switch (_context27.p = _context27.n) {
          ...
          case 2:
            _yield$client$from$se4 = _context27.v;
          ...
          case 4:
            _context27.p = 4;
            _t19 = _context27.v;
            alert('更新失败: ' + (_t19.message || _t19));
          case 5:
            return _context27.a(2);
        }
      }, _callee24, null, [[1, 4]]);
    }));
    return function toggleWatcher(_x14, _x15) {
  ...
  var deleteMsg = /*#__PURE__*/function () {
    var _ref54 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee25() {
      var client, _yield$client$from$up3, error, _t20;
      return _regenerator().w(function (_context28) {
        while (1) switch (_context28.p = _context28.n) {
          ...
          case 4:
            _yield$client$from$up3 = _context28.v;
...
var ShopOwnersManager = function ShopOwnersManager(_ref55) {
  var user = _ref55.user,
    employees = _ref55.employees,
    _ref55$shopOwners = _ref55.shopOwners,
    shopOwners = _ref55$shopOwners === void 0 ? [] : _ref55$shopOwners,
    onClose = _ref55.onClose,
    toast = _ref55.toast;
  var _useState177 = useState(null),
    _useState178 = _slicedToArray(_useState177, 2),
    editing = _useState178[0],
    setEditing = _useState178[1]; // { shopName, userId, userName, role, notes, id? }
  var _useState179 = useState(false),
    _useState180 = _slicedToArray(_useState179, 2),
    showNew = _useState180[0],
    setShowNew = _useState180[1];
  var isAdmin = user.role === 'admin' || user.role === 'super_admin';
  // 🆕 fix67: 三方数据对齐诊断 — 加载 org_directory 统计
  var _useState181 = useState(null),
    _useState182 = _slicedToArray(_useState181, 2),
    orgDir = _useState182[0],
    setOrgDir = _useState182[1];
  useEffect(function () {
  ...
  var saveOwner = /*#__PURE__*/function () {
    var _ref57 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee27(record) {
      var client, row, _yield$client$from$up4, error, _t23;
      return _regenerator().w(function (_context30) {
        while (1) switch (_context30.p = _context30.n) {
          ...
          case 2:
            _yield$client$from$up4 = _context30.v;
    ...
    return function saveOwner(_x16) {
  ...
  var saveOwnersBatch = /*#__PURE__*/function () {
    var _ref59 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee28(_ref58) {
      var shopNames, userIds, role, notes, client, existingKeys, rows, skipped, _yield$client$from$in2, error, _t24;
      return _regenerator().w(function (_context31) {
        while (1) switch (_context31.p = _context31.n) {
          case 0:
            shopNames = _ref58.shopNames, userIds = _ref58.userIds, role = _ref58.role, notes = _ref58.notes;
            client = getCdmClient();
            if (client) {
              _context31.n = 1;
              break;
          ...
          case 3:
            _yield$client$from$in2 = _context31.v;
          ...
          case 5:
            _context31.p = 5;
            _t24 = _context31.v;
            alert('批量保存失败: ' + (_t24.message || _t24));
          case 6:
            return _context31.a(2);
        }
      }, _callee28, null, [[1, 5]]);
    }));
    return function saveOwnersBatch(_x17) {
      return _ref59.apply(this, arguments);
    };
  }();
  var deleteOwner = /*#__PURE__*/function () {
    var _ref60 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee29(owner) {
      var client, _yield$client$from$de, error, _t25;
      return _regenerator().w(function (_context32) {
        while (1) switch (_context32.p = _context32.n) {
          ...
          case 5:
            _yield$client$from$de = _context32.v;
          ...
          case 7:
            _context32.p = 7;
            _t25 = _context32.v;
            alert('删除失败: ' + (_t25.message || _t25));
          case 8:
            return _context32.a(2);
        }
      }, _callee29, null, [[4, 7]]);
    }));
    return function deleteOwner(_x18) {
  ...
  }, "\u6682\u65E0\u5E97\u94FA\u6620\u5C04 \xB7 \u70B9\u53F3\u4E0A\"+ \u65B0\u589E\u6620\u5C04\"\u6DFB\u52A0\u7B2C\u4E00\u4E2A") : grouped.map(function (_ref61) {
...
var ShopOwnerEditor = function ShopOwnerEditor(_ref63) {
  var record = _ref63.record,
    employees = _ref63.employees,
    existingShopNames = _ref63.existingShopNames,
    onSave = _ref63.onSave,
    onSaveBatch = _ref63.onSaveBatch,
    onClose = _ref63.onClose;
  var isEdit = !!record.id;
  // 🆕 fix23: 批量模式 (仅新增时可用)
  var _useState183 = useState(false),
    _useState184 = _slicedToArray(_useState183, 2),
    batchMode = _useState184[0],
    setBatchMode = _useState184[1];
  ...
  var _useState185 = useState(initShopVal),
    _useState186 = _slicedToArray(_useState185, 2),
    shopName = _useState186[0],
    setShopName = _useState186[1];
  var _useState187 = useState(isEdit && !initIsPreset ? record.shopName || '' : ''),
    _useState188 = _slicedToArray(_useState187, 2),
    customShopName = _useState188[0],
    setCustomShopName = _useState188[1];
  var _useState189 = useState(record.userId || ''),
    _useState190 = _slicedToArray(_useState189, 2),
    userId = _useState190[0],
    setUserId = _useState190[1];
  var _useState191 = useState(record.role || 'primary'),
    _useState192 = _slicedToArray(_useState191, 2),
    role = _useState192[0],
    setRole = _useState192[1];
  var _useState193 = useState(record.notes || ''),
    _useState194 = _slicedToArray(_useState193, 2),
    notes = _useState194[0],
    setNotes = _useState194[1];
  ...
  var _useState197 = useState([]),
    ...
    batchShops = _useState198[0],
    setBatchShops = _useState198[1]; // 选中的 shopName 数组
  var _useState199 = useState([]),
    _useState200 = _slicedToArray(_useState199, 2),
    batchUserIds = _useState200[0],
    setBatchUserIds = _useState200[1]; // 选中的员工 id 数组
  var _useState201 = useState(''),
    _useState202 = _slicedToArray(_useState201, 2),
    batchCustomShop = _useState202[0],
    setBatchCustomShop = _useState202[1];
  var _useState203 = useState(false),
    _useState204 = _slicedToArray(_useState203, 2),
    batchIncludeCustom = _useState204[0],
    setBatchIncludeCustom = _useState204[1];
  ...
  var submitBatch = /*#__PURE__*/function () {
    var _ref65 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee31() {
      var shops;
...
// ════════════════════════════════════════════════════════════════════
var TimeoutSettingsModal = function TimeoutSettingsModal(_ref66) {
  var user = _ref66.user,
    _ref66$cdmTimeoutConf = _ref66.cdmTimeoutConfig,
    cdmTimeoutConfig = _ref66$cdmTimeoutConf === void 0 ? {} : _ref66$cdmTimeoutConf,
  ...
  var _useState205 = useState(function () {
    ...
    config = _useState206[0],
    setConfig = _useState206[1];
  var _useState207 = useState(CDM_CATEGORIES[0].id),
    _useState208 = _slicedToArray(_useState207, 2),
    activeCat = _useState208[0],
    setActiveCat = _useState208[1];
  var _useState209 = useState(false),
    _useState210 = _slicedToArray(_useState209, 2),
    saving = _useState210[0],
    setSaving = _useState210[1];
  var isAdmin = user.role === 'admin' || user.role === 'super_admin';
  ...
  var save = /*#__PURE__*/function () {
    var _ref68 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee33() {
      var client, _yield$client$from$se5, data, latest, merged, _yield$client$from$up5, error, _t26;
      return _regenerator().w(function (_context36) {
        while (1) switch (_context36.p = _context36.n) {
          ...
          case 3:
            _yield$client$from$se5 = _context36.v;
          ...
          case 4:
            _yield$client$from$up5 = _context36.v;
...
var PhotoRequestsModule = function PhotoRequestsModule(_ref69) {
  var _window$isWtkpiConfig, _window;
  var user = _ref69.user,
    toast = _ref69.toast;
  // 🆕 fix53 v3: 默认 sub-tab = 'all-activities' (全部工作动态)
  var _useState211 = useState('all-activities'),
    _useState212 = _slicedToArray(_useState211, 2),
    filter = _useState212[0],
    setFilter = _useState212[1];
  ...
  var _useState215 = useState([]),
    ...
    list = _useState216[0],
    setList = _useState216[1];
  var _useState217 = useState(false),
    _useState218 = _slicedToArray(_useState217, 2),
    showNew = _useState218[0],
    setShowNew = _useState218[1];
  var _useState219 = useState(false),
    _useState220 = _slicedToArray(_useState219, 2),
    showBatch = _useState220[0],
    setShowBatch = _useState220[1];
  var _useState221 = useState(null),
    _useState222 = _slicedToArray(_useState221, 2),
    detailItem = _useState222[0],
    setDetailItem = _useState222[1];
  var _useState223 = useState(null),
    _useState224 = _slicedToArray(_useState223, 2),
    editItem = _useState224[0],
    setEditItem = _useState224[1];
  var _useState225 = useState(((_window$isWtkpiConfig = (_window = window).isWtkpiConfigured) === null || _window$isWtkpiConfig === void 0 ? void 0 : _window$isWtkpiConfig.call(_window)) || false),
    _useState226 = _slicedToArray(_useState225, 2),
    configured = _useState226[0],
    setConfigured = _useState226[1];
  var lastRefreshRef = useRef(0);
  // 🆕 fix140: 分页 — 默认 150 条,「加载更多」每次 +150。refresh 重拉「当前已加载量」,
  //           保证客户端 sub-tab 筛选语义不变(在已加载集上过滤),且不再一次性全表拉。
  var PHOTO_PAGE = 150;
  var _useState227 = useState(PHOTO_PAGE),
    _useState228 = _slicedToArray(_useState227, 2),
    loadedCount = _useState228[0],
    setLoadedCount = _useState228[1];
  var _useState229 = useState(false),
    _useState230 = _slicedToArray(_useState229, 2),
    hasMore = _useState230[0],
    setHasMore = _useState230[1];
  var _useState231 = useState(false),
    _useState232 = _slicedToArray(_useState231, 2),
    loadingMore = _useState232[0],
    setLoadingMore = _useState232[1];
  var refresh = /*#__PURE__*/function () {
    var _ref70 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee34(count) {
      ...
      return _regenerator().w(function (_context37) {
        while (1) switch (_context37.p = _context37.n) {
          ...
          case 4:
            _context37.p = 4;
            _t27 = _context37.v;
            console.error('[PhotoReq] 加载失败', _t27);
            toast('加载拍摄需求失败:' + (_t27.message || ''));
          case 5:
            setLoading(false);
          case 6:
            return _context37.a(2);
    ...
    return function refresh(_x19) {
      return _ref70.apply(this, arguments);
    };
  }();
  var loadMore = /*#__PURE__*/function () {
    var _ref71 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee35() {
      var next, data, _t28;
      return _regenerator().w(function (_context38) {
        while (1) switch (_context38.p = _context38.n) {
          ...
          case 4:
            _context38.p = 4;
            _t28 = _context38.v;
            console.error('[PhotoReq] 加载更多失败', _t28);
          case 5:
  ...
  useEffect(function () {
    ...
    if (!client) return;
    var channel = client.channel("cs-photo-logs-".concat(user.id, "-").concat(Date.now())).on('postgres_changes', {
      event: '*',
      schema: 'public',
      table: 'photo_logs'
    }, function (payload) {
  ...
  var myWarehoused = list.filter(function (r) {
    var _r$external_request3;
    return ((_r$external_request3 = r.external_request) === null || _r$external_request3 === void 0 ? void 0 : _r$external_request3.from_user_id) === user.id && isWarehoused(r);
  });
  if (!configured) {
    return /*#__PURE__*/React.createElement("div", {
      className: "paper rounded-2xl",
  ...
  var counts = {
    ...
    mine: activeList.filter(function (r) {
      var _r$external_request4;
      return ((_r$external_request4 = r.external_request) === null || _r$external_request4 === void 0 ? void 0 : _r$external_request4.from_user_id) === user.id;
    }).length,
    urgent: activeList.filter(function (r) {
      var _r$external_request5;
      return (r.priority === 'urgent' || ((_r$external_request5 = r.external_request) === null || _r$external_request5 === void 0 ? void 0 : _r$external_request5.urgency) === 'urgent') && r.status !== 'done';
    }).length,
...
var PhotoRequestCard = function PhotoRequestCard(_ref72) {
  var _item$applicable_shop, _PHOTO_STATUS_MAP$wh$;
  var item = _ref72.item,
    currentUserId = _ref72.currentUserId,
    onOpen = _ref72.onOpen,
    onEdit = _ref72.onEdit,
    toast = _ref72.toast;
...
var PhotoRequestNewModal = function PhotoRequestNewModal(_ref73) {
  var user = _ref73.user,
    toast = _ref73.toast,
    onClose = _ref73.onClose,
    onSuccess = _ref73.onSuccess,
    _ref73$prefill = _ref73.prefill,
    prefill = _ref73$prefill === void 0 ? {} : _ref73$prefill;
  var _useState233 = useState(prefill.productName || ''),
    _useState234 = _slicedToArray(_useState233, 2),
    productName = _useState234[0],
    setProductName = _useState234[1];
  var _useState235 = useState(prefill.sku || ''),
    _useState236 = _slicedToArray(_useState235, 2),
    sku = _useState236[0],
    setSku = _useState236[1];
  var _useState237 = useState(prefill.shops || []),
    _useState238 = _slicedToArray(_useState237, 2),
    shops = _useState238[0],
    setShops = _useState238[1];
  var _useState239 = useState(prefill.reason || ''),
    _useState240 = _slicedToArray(_useState239, 2),
    reason = _useState240[0],
    setReason = _useState240[1];
  var _useState241 = useState('normal'),
    _useState242 = _slicedToArray(_useState241, 2),
    urgency = _useState242[0],
    setUrgency = _useState242[1];
  var _useState243 = useState([]),
    _useState244 = _slicedToArray(_useState243, 2),
    attachments = _useState244[0],
    setAttachments = _useState244[1];
  var _useState245 = useState(false),
    _useState246 = _slicedToArray(_useState245, 2),
    uploading = _useState246[0],
    setUploading = _useState246[1];
  var _useState247 = useState(false),
    _useState248 = _slicedToArray(_useState247, 2),
    submitting = _useState248[0],
    setSubmitting = _useState248[1];
  var _useState249 = useState(false),
    _useState250 = _slicedToArray(_useState249, 2),
    dragOver = _useState250[0],
    setDragOver = _useState250[1]; // 🆕 fix83: 拖拽高亮
  ...
  var uploadFiles = /*#__PURE__*/function () {
    var _ref74 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee36(files) {
      var imgs, newAttachments, _iterator6, _step6, f, a, _t29, _t30;
      return _regenerator().w(function (_context39) {
        while (1) switch (_context39.p = _context39.n) {
          ...
          case 6:
            _context39.p = 6;
            _t29 = _context39.v;
            toast('上传 ' + (f.name || '图片') + ' 失败:' + _t29.message);
          case 7:
            _context39.n = 3;
            break;
          case 8:
  ...
  var submit = /*#__PURE__*/function () {
    var _ref76 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee38() {
      var _t31;
      return _regenerator().w(function (_context41) {
        while (1) switch (_context41.p = _context41.n) {
          ...
          case 7:
            _context41.p = 7;
            _t31 = _context41.v;
            console.error('[PhotoReq] 提交失败', _t31);
            alert('提交失败:\n\n' + (_t31.message || JSON.stringify(_t31)) + '\n\n常见原因:\n• 配置的 URL/Key 错了\n• Supabase RLS 拒绝写入 (联系拍摄部主管配 policy)\n• 网络问题');
          case 8:
            setSubmitting(false);
          case 9:
            return _context41.a(2);
...
// ════════════════════════════════════════════════════════════════════
var PhotoRequestEditModal = function PhotoRequestEditModal(_ref78) {
  ...
  var ext = item.external_request || {};
  var _useState251 = useState(item.product_name || ''),
    _useState252 = _slicedToArray(_useState251, 2),
    productName = _useState252[0],
    setProductName = _useState252[1];
  var _useState253 = useState(item.sku || ''),
    _useState254 = _slicedToArray(_useState253, 2),
    sku = _useState254[0],
    setSku = _useState254[1];
  var _useState255 = useState(item.applicable_shops || []),
    _useState256 = _slicedToArray(_useState255, 2),
    shops = _useState256[0],
    setShops = _useState256[1];
  var _useState257 = useState(item.product_type || '常规产品'),
    _useState258 = _slicedToArray(_useState257, 2),
    productType = _useState258[0],
    setProductType = _useState258[1];
  var _useState259 = useState(item.product_notes || ''),
    _useState260 = _slicedToArray(_useState259, 2),
    productNotes = _useState260[0],
    setProductNotes = _useState260[1];
  var _useState261 = useState(''),
    _useState262 = _slicedToArray(_useState261, 2),
    reasonAppend = _useState262[0],
    setReasonAppend = _useState262[1];
  var _useState263 = useState([]),
    _useState264 = _slicedToArray(_useState263, 2),
    newAttachments = _useState264[0],
    setNewAttachments = _useState264[1];
  var _useState265 = useState(false),
    _useState266 = _slicedToArray(_useState265, 2),
    uploading = _useState266[0],
    setUploading = _useState266[1];
  var _useState267 = useState(false),
    _useState268 = _slicedToArray(_useState267, 2),
    saving = _useState268[0],
    setSaving = _useState268[1];
  var toggleShop = function toggleShop(label) {
    setShops(function (prev) {
      return prev.includes(label) ? prev.filter(function (s) {
        return s !== label;
  ...
  var handleFiles = /*#__PURE__*/function () {
    var _ref79 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee39(e) {
      var files, news, _i2, _files, f, a, _t32;
      return _regenerator().w(function (_context42) {
        while (1) switch (_context42.p = _context42.n) {
          ...
          case 5:
            _context42.p = 5;
            _t32 = _context42.v;
            toast('上传 ' + f.name + ' 失败:' + _t32.message);
          case 6:
            _i2++;
            _context42.n = 2;
            break;
  ...
  var save = /*#__PURE__*/function () {
    var _ref80 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee40() {
      var _t33;
      return _regenerator().w(function (_context43) {
        while (1) switch (_context43.p = _context43.n) {
          ...
          case 5:
            _context43.p = 5;
            _t33 = _context43.v;
            console.error('[PhotoReq Edit] 保存失败', _t33);
            alert('保存失败:\n\n' + (_t33.message || JSON.stringify(_t33)));
          case 6:
            setSaving(false);
          case 7:
            return _context43.a(2);
...
var RowAttachments = function RowAttachments(_ref81) {
  var items = _ref81.items,
  ...
  var _useState271 = useState(false),
    ...
    dragOver = _useState272[0],
    setDragOver = _useState272[1];
  var _useState273 = useState(false),
    _useState274 = _slicedToArray(_useState273, 2),
    focused = _useState274[0],
    setFocused = _useState274[1]; // 🆕 fix64: 聚焦提示
  var _useState275 = useState(null),
    _useState276 = _slicedToArray(_useState275, 2),
    preview = _useState276[0],
    setPreview = _useState276[1]; // 🆕 fix64: 放大预览 lightbox
  var fileInputRef = useRef(null);
  var handleFiles = /*#__PURE__*/function () {
    var _ref82 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee41(files) {
      var list, news, _iterator8, _step8, f, a, _t34, _t35;
      return _regenerator().w(function (_context44) {
        while (1) switch (_context44.p = _context44.n) {
          ...
          case 6:
            _context44.p = 6;
            _t34 = _context44.v;
            toast('上传 ' + f.name + ' 失败:' + (_t34.message || ''));
          case 7:
            _context44.n = 3;
            break;
          case 8:
  ...
  var handlePaste = /*#__PURE__*/function () {
    var _ref83 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee42(e) {
    ...
    return function handlePaste(_x24) {
      return _ref83.apply(this, arguments);
    };
  }();
  var handleDrop = /*#__PURE__*/function () {
    var _ref84 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee43(e) {
      var _e$dataTransfer;
    ...
    return function handleDrop(_x25) {
...
var PhotoRequestBatchModal = function PhotoRequestBatchModal(_ref85) {
  var user = _ref85.user,
    toast = _ref85.toast,
    onClose = _ref85.onClose,
    onSuccess = _ref85.onSuccess;
  var _useState277 = useState([{
    ...
    rows = _useState278[0],
    setRows = _useState278[1];
  var _useState279 = useState([]),
    _useState280 = _slicedToArray(_useState279, 2),
    defaultShops = _useState280[0],
    setDefaultShops = _useState280[1];
  var _useState281 = useState('normal'),
    _useState282 = _slicedToArray(_useState281, 2),
    defaultUrgency = _useState282[0],
    setDefaultUrgency = _useState282[1];
  var _useState283 = useState(''),
    _useState284 = _slicedToArray(_useState283, 2),
    reasonPrefix = _useState284[0],
    setReasonPrefix = _useState284[1];
  var _useState285 = useState(false),
    _useState286 = _slicedToArray(_useState285, 2),
    submitting = _useState286[0],
    setSubmitting = _useState286[1];
      ...
      return _regenerator().w(function (_context47) {
        while (1) switch (_context47.p = _context47.n) {
          ...
          case 6:
            _context47.p = 6;
            _t36 = _context47.v;
            console.error('[PhotoReq Batch] 失败', _t36);
            alert('批量提交失败:\n\n' + (_t36.message || JSON.stringify(_t36)));
          case 7:
            setSubmitting(false);
          case 8:
            return _context47.a(2);
